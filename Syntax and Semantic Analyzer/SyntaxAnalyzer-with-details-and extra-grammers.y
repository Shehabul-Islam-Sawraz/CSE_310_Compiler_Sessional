...
statements: statement
                ...
                //                         printErrorRecovery("Invalid statement", statements, "statements error");
                //                 }
                |       statements error
                                {
                                        //setValue(statements,popValue(statements)+" "+popValue(error));
                                        setValue(statements,popValue(statements));
                                        //printRuleAndCode(statements,"statements error");
                                }                
                ;
...
factor: variable        
                ...
                |       ID LPAREN argument_list error
                                {
                                        setValue(factor,$1->getName()+"("+popValue(argument_list)+"");
                                        printErrorRecovery("Right parentheses missing",factor,"ID LPAREN argument_list error");
                                        clearFunctionParam();
                                }
